...
const openCodeManagement = () => $("#code-management-modal").classList.remove("hidden"); $("#source-manager").onclick = openCodeManagement; $("#artifact-manager").onclick = openCodeManagement; $("#close-code-management").onclick = () => $("#code-management-modal").classList.add("hidden"); $("#code-management-modal").onclick = (event) => { if (event.target === event.currentTarget) $("#code-management-modal").classList.add("hidden"); };
